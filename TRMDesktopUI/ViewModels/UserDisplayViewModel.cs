    ...
    public class UserDisplayViewModel : Screen
    {
        ...
        public UserModel SelectedUser
        {
            ...
            { 
                ...
                LoadRoles().Wait(); // causes a deadlock
        ...
        protected override async void OnViewLoaded(object view)
        {
            ...
            {
                dynamic settings = new ExpandoObject(); // error dialog setting properties
                ...
                {
                    _status.UpdateMessage("Unauthorized Access", "You do not have permission to access sales view");
        ...
        private async Task LoadRoles()
        {
            ...
            {
                if (UserRoles.Contains(role.Value) == false)
                {
